<div>
    ...
    <x-modal id="sub-area-surveys-modal" wire:model="showingModal">
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.sub_area_surveys.inputs.survey_period_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_area_surveys.inputs.sub_category_id')
                    </th>
                    <th class="text-left">
                        Survey Result
                    </th>
                ...
                @foreach ($surveys as $survey)
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="text-left">
                            ...
                            @endphp
                            <p class="badge badge-{{ $color }}">{{ $settlementByBusinessUnits ?? '-' }}</p>
                        </td>
