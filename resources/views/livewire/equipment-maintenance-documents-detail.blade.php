<div>
    ...
    <x-modal
        id="equipment-maintenance-documents-modal"
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.equipment_maintenance_documents.inputs.document_name')
                    </th>
                    <th class="text-left">
                        @lang('crud.equipment_maintenance_documents.inputs.document_remarks')
                    </th>
                    <th class="text-left">
                        @lang('crud.equipment_maintenance_documents.inputs.document_file')
                    </th>
                    <th></th>
                </tr>
            </thead>
