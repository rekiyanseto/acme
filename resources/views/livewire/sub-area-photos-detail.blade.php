<div>
    ...
    <x-modal id="sub-area-photos-modal" wire:model="showingModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <x-inputs.group class="col-sm-12">
                        <div
                            image-url="{{ $editing && $photo->photo ? asset(\Storage::url($photo->photo)) : '' }}"
                            x-data="imageViewer()"
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.sub_area_photos.inputs.survey_period_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_area_photos.inputs.photo')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_area_photos.inputs.remarks')
                    </th>
                    <th></th>
                </tr>
            </thead>
