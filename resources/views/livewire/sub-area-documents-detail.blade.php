<div>
    ...
    <x-modal id="sub-area-documents-modal" wire:model="showingModal">
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.sub_area_documents.inputs.document_name')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_area_documents.inputs.document_description')
                    </th>
                    <th class="text-left">
                        @lang('crud.sub_area_documents.inputs.document_link')
                    </th>
                    <th></th>
                </tr>
            </thead>
