    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">@lang('crud.equipments.index_title')</h4>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            <th class="text-left">
                                @lang('crud.equipments.inputs.sub_area_id')
                            </th>
                            <th class="text-left">
                                @lang('crud.equipments.inputs.equipment_code')
                            </th>
                            <th class="text-left">
                                @lang('crud.equipments.inputs.equipment_name')
                            </th>
                            <th class="text-left">
                                @lang('crud.equipments.inputs.maintenance_by')
                            </th>
                            <th class="text-left">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $equipment->maintenance_by ?? '-' }}</td>
                            <td>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6">{!! $equipments->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
