        ...
        <div class="row">
            ...
            <div class="col-8 mb-3">
                <div class="card h-100">
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="{{ route('areas.index') }}" class="mr-4"><i class="icon ion-md-arrow-back"></i></a>
                            @lang('crud.areas.show_title')
                        </h4>

                        <div class="mt-4">
                            <div class="mb-4">
                                <h5>@lang('crud.areas.inputs.functional_location_id')</h5>
                                <span>{{ optional($area->functionalLocation)->functional_location_name ?? '-' }}</span>
                            </div>
                            <div class="mb-4">
                                <h5>@lang('crud.areas.inputs.area_code')</h5>
                                <span>{{ $area->area_code ?? '-' }}</span>
                            </div>
                            <div class="mb-4">
                                <h5>@lang('crud.areas.inputs.area_name')</h5>
                        ...
                        <div class="card-body">
                            <div id="myPanzoom" class="panzoom" style="height: 500px;">
                                <img class="panzoom__content"
                                    src="{{ asset(\Storage::url($area->area_site_plan)) }}" alt="" />
                            </div>
                            <script>
