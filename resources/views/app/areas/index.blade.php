            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            <th class="text-left">
                                @lang('crud.areas.inputs.functional_location_id')
                            </th>
                            <th class="text-left">
                                @lang('crud.areas.inputs.area_code')
                            </th>
                            <th class="text-left">
                                @lang('crud.areas.inputs.area_name')
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                {{
                                optional($area->functionalLocation)->functional_location_name
                                ?? '-' }}
                            </td>
